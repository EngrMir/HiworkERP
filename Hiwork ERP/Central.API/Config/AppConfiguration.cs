...
namespace Central.API.Config
{
    public class AppConfiguration : ConfigurationSection
    {
        ...
        [ConfigurationProperty("cORSOriginator")]
        public string CORSOriginator
        {
            get { return (string)this["cORSOriginator"]; }
            set { this["cORSOriginator"] = value; }
        } 
